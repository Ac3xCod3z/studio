    ...
    <div className="bg-background min-h-screen">
      ...
      <main className="max-w-4xl mx-auto py-12 px-4 md:px-6">
        <div className="space-y-8 text-foreground">
          <h1 className="text-4xl font-bold">Privacy Policy for FiscalFlow</h1>
          <p className="text-muted-foreground">Last updated: {new Date().toLocaleDateString()}</p>

          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">Introduction</h2>
            <p>
              Welcome to FiscalFlow ("we," "us," or "our"). We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our application. By using FiscalFlow, you agree to the collection and use of information in accordance with this policy.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              FiscalFlow is designed to be privacy-focused. Your financial data is primarily stored on your own device.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>To provide and maintain the core functionality of the FiscalFlow application.</li>
